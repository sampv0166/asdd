...
const VariationOptions = ({
  ...
  return (
    <>
      {loadingVariationUpdate || loadingproductDetails ? (
        <Loader />
      ) : errorVariationUpdate || errorproductDetails ? (
        <Message />
      ) : (
        <Formik
          enableReinitialize
          ...
          {(formik) => (
            <Form>
              <div>
                ...
                <div className="row ">
                  <div class="form-check form-switch col-md-3 mx-3">
                    <input
                      ...
                      onChange={(d) => {
                        hasOffer.checked === true ? (d = false) : (d = true);
                ...
                <div className="row my-3">
                  ...
                  <div className="col-4">
                    <button
                      className="text-nowrap btn btn-outline-success  rounded"
                      onClick={(e) => {
                        e.preventDefault();
